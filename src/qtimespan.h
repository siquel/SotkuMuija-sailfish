...
public:
    ...
    // constant time units
    static QTimeSpan second();
    static QTimeSpan minute();
    static QTimeSpan hour();
    static QTimeSpan day();
    static QTimeSpan week();
...
inline QTimeSpan operator*(qreal left, const QTimeSpan &right) {return right * left;}
inline QTimeSpan operator*(int left, const QTimeSpan &right) {return right * left;}
Q_CORE_EXPORT QTimeSpan operator/(const QTimeSpan &left, qreal right);
Q_CORE_EXPORT QTimeSpan operator/(const QTimeSpan &left, int right);
